...
export default function Home3() {
  return (
    <>
      {/* Hero with background image - teal gradient overlay */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          ...
          <p className="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto mb-10 leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/wmo-zorg"
              className="px-8 py-4 bg-teal-surface text-teal-dark font-semibold rounded-xl hover:bg-white transition-all hover:shadow-lg text-base"
            >
              WMO-zorg
            </Link>
            <Link
              href="/forensische-zorg"
              className="px-8 py-4 bg-white/10 text-white font-semibold rounded-xl border border-white/30 hover:bg-white/20 transition-all text-base backdrop-blur-sm"
            >
              Forensische zorg
            </Link>
            <Link
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-end p-10 sm:p-12">
                ...
                <p className="text-white/85 leading-relaxed mb-4 drop-shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={item.title}
                className="bg-teal-surface rounded-2xl p-8 border border-teal-light/40"
              >
      ...
      >
        <div className="py-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="px-8 py-4 bg-teal-surface text-teal-dark font-semibold rounded-xl hover:bg-white transition-all text-base"
            >
              Contactformulier
            </Link>
            <a
